...
def load_pile_lmsys_mixed_tokens():
    try:
        ...
        all_tokens = torch.load("/home/taywonmin/rewardmodel-crosscoder/data/pile-lmsys-mix-1m-tokenized-gemma-2.pt")
    except:
        print("Data is not cached. Loading data from HF")
        data = load_dataset(
            "ckkissane/pile-lmsys-mix-1m-tokenized-gemma-2", 
            split="train", 
            cache_dir="/home/taywonmin/rewardmodel-crosscoder/cache/"
        )
        data.save_to_disk("/home/taywonmin/rewardmodel-crosscoder/data/pile-lmsys-mix-1m-tokenized-gemma-2.hf")
        data.set_format(type="torch", columns=["input_ids"])
        all_tokens = data["input_ids"]
        torch.save(all_tokens, "/home/taywonmin/rewardmodel-crosscoder/data/pile-lmsys-mix-1m-tokenized-gemma-2.pt")
