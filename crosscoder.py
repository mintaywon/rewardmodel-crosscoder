...
SAVE_DIR = Path("/home/taywonmin/rewardmodel-crosscoder/checkpoints")
...
class CrossCoder(nn.Module):
    ...
    def create_save_dir(self):
        base_dir = Path("/home/taywonmin/rewardmodel-crosscoder/checkpoints")
        version_list = [
    ...
    def load(cls, version_dir, checkpoint_version):
        save_dir = Path("/home/taywonmin/rewardmodel-crosscoder/checkpoints") / str(version_dir)
